...
<html lang="zh-tw">
   ...
   <body>
         ...
         <div class="row" style=" margin-top: 50px;">
            ...
            <div class="col-md-8">
               ...
               <div class="n1">
                  ...
                  <dl class="dl-horizontal">
                     <dt>開場：</dt>
                     <dd>16位輕騎兵、12位駱駝騎兵、2位阿拉伯奴隸兵、12位裝甲步兵、2台重型弩砲。</dd>
                     <dt>大地之母單位：</dt>
            ...
            <div class="col-md-4 ">
               <table class="table-bordered " width="100%">
                  ...
                  <tr>
                     <td colspan="2 " >
                        <div class="unititle "><img src="img/An_arabian_knight.png" width=" " alt=" "></div>
                     </td>
                  </tr>
                  <tr>
                     <td class="unit" colspan="2 " style=" background-color:#375d96; ">
                  ...
                  <tr>
                     ...
                     <td class="unit4 ">        <a href="Lord_of_Arabia.php">阿拉伯之主</a>        </td>
                  </tr>
               </table>
      ...
      <!-- /container --><?php include("allbatt.php "); ?><?php include("foot.php "); ?>
   </body>
</html>